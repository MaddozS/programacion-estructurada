#include <stdio.h>
#include <conio.h>
/* Se definen las constantes y macros */
#define TOTAL_ALUMNOS 50
#define FOR(A,B) for(A=1; A<=B; A++)


/*
Nombre: 47_mayor-al-promedio_macros.c
...
int main(int argc, char *argv[]) {
	...
	//Entrada 1: se piden las calificaciones del cada alumno para obtener el promedio USANDO MACROS
	...
	/* Entrada 2: las calificaciones se piden de nuevo para saber si estan arriba del promedio USANDO MACROS*/
...
el código funciona correctamente si el usario no ingresa valores negativos, hace uso del define correctamente.*/
